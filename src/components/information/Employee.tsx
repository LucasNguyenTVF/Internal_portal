...
export const DisplayEmployeeInfo = (
  ...
  return (
    <>
      <div
        key={employee.id}
        className="bg-[linear-gradient(90deg,_#03081A_0%,_#012756_100%)]  cursor-pointer border shadow-md border-gray-800 rounded-lg px-1.5 py-2 hover:bg-gray-750 transition-colors w-full sm:w-auto"
